...
public class Obra {
    ...
    public Long getId(){return id;} public String getNome(){return nome;} public void setNome(String v){nome=v;} public String getCliente(){return cliente;} public void setCliente(String v){cliente=v;} public String getCidade(){return cidade;} public void setCidade(String v){cidade=v;} public LocalDate getInicio(){return inicio;} public void setInicio(LocalDate v){inicio=v;} public String getStatus(){return status;} public void setStatus(String v){status=v;} public Set<Funcionario> getResponsaveis(){return responsaveis;} public void setResponsaveis(Set<Funcionario> v){responsaveis=v;}
}
