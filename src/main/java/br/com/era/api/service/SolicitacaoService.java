...
public class SolicitacaoService {
    ...
    @Transactional public SolicitacaoDto.Resposta cadastrar(SolicitacaoDto.Requisicao d){Solicitacao s=new Solicitacao();s.setTipo("Movimentação");s.setStatus("Pendente");s.setTecnico(funcionarios.buscarPorNome(d.tecnico()));s.setObraOrigem(obras.buscarOpcional(d.obraOrigemId()));s.setObraDestino(obras.buscarOpcional(d.obraDestinoId()));s.setDataSolicitacao(d.dataSolicitacao());s.setObservacao(d.observacao());s.substituirMateriais(criarMateriais(d.materiais()));return resposta(repository.save(s));}
