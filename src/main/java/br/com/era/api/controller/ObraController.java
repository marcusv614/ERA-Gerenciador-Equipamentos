...
public class ObraController {
    ...
    @GetMapping public List<ObraDto.Resposta> listar(){return service.listar();}
    ...
    @GetMapping("/{id}/historico") public List<MovimentacaoDto.Resposta> historico(@PathVariable Long id){service.buscar(id);return movimentacoes.findByObraOrigemIdOrObraDestinoIdOrderByDataMovimentacaoAscIdAsc(id,id).stream().map(equipamentos::respostaMovimentacao).toList();}
}
