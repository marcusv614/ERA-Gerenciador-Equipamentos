...
export const apiAtividades = {
  ...
  registrarAquisicao: (atividadeId, materialId, quantidade, identificacao) => criar(ROTAS_API.registrarAquisicaoMaterial(atividadeId, materialId), { quantidade, identificacao }),
