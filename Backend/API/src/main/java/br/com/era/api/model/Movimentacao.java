...
public class Movimentacao {
    ...
    @Column(nullable=false,length=40) private String status; @Column(name="data_movimentacao",nullable=false) private LocalDate dataMovimentacao; @Column(name="criado_em",nullable=false) private OffsetDateTime criadoEm;
