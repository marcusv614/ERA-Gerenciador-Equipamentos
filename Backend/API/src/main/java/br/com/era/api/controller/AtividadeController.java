...
public class AtividadeController {
    ...
    @PostMapping("/{id}/materiais/{materialId}/aquisicao") public SolicitacaoDto.Resposta registrarAquisicao(@PathVariable Long id,@PathVariable Long materialId,@Valid @RequestBody SolicitacaoDto.RegistrarAquisicao dados){return service.registrarAquisicao(id,materialId,dados.quantidade(),dados.identificacao());}
