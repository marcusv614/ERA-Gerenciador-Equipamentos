...
public final class SolicitacaoDto {
    ...
    public record Resposta(Long id,String tipo,String status,String solicitante,String tecnico,Long obraOrigemId,Long obraDestinoId,LocalDate dataSolicitacao,LocalDate dataDecisao,String observacao,List<MaterialResposta> materiais) {}
}
