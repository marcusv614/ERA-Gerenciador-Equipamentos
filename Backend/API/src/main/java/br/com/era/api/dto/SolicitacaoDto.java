...
public final class SolicitacaoDto {
    ...
    public record MaterialResposta(Long id,String nome,Integer quantidade,String identificacao,String catalogoChave,Integer quantidadeCompra,OffsetDateTime compraSolicitadaEm,Integer quantidadeAdquirida,Integer quantidadeEntradaEstoque,OffsetDateTime adquiridaEm) {}
    public record SolicitarCompra(@NotNull @Min(1) Integer quantidade) {}
    public record RegistrarAquisicao(@NotNull @Min(1) Integer quantidade,@NotBlank @Size(max=120) String identificacao) {}
