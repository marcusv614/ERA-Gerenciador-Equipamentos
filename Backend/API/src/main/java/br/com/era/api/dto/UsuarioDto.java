...
public final class UsuarioDto {
    private UsuarioDto() {}
    public record Cadastro(Long funcionarioId,@NotBlank String nome,@NotBlank String login,@NotBlank @Size(min=6,max=128) String senhaTemporaria,@NotNull PerfilUsuario perfil) {}
    ...
    public record RedefinirSenha(@NotBlank @Size(min=6,max=128) String senhaTemporaria) {}
}
