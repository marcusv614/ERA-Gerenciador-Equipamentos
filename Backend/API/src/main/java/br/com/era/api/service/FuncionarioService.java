...
public class FuncionarioService {
    private final FuncionarioRepository repository; private final ObraRepository obras;
    public FuncionarioService(FuncionarioRepository repository,ObraRepository obras){this.repository=repository;this.obras=obras;}
